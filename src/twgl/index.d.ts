 ...
 * @memberOf module:twgl
 */
export function createTransformFeedbackInfo(
 ...
 * @memberOf module:twgl
 */
export function bindTransformFeedbackInfo(
  gl: WebGLRenderingContext,
 ...
 * @memberOf module:twgl
 */
export type CubemapReadyCallback = (
  err: any,
  tex: WebGLTexture,
 ...
 * @memberOf module:twgl
 */
export type ThreeDReadyCallback = (
  err: any,
  tex: WebGLTexture,
  imgs: HTMLImageElement[]
) => void;
 ...
 * @memberOf module:twgl/draw
 */
export function drawObjectList(
  gl: WebGLRenderingContext,
 ...
 * @memberOf module:twgl/programs
 */
export function createUniformBlockInfo(
 ...
 * @memberOf module:twgl/programs
 */
export function setBlockUniforms(
  uniformBlockInfo: UniformBlockInfo,
  values: {
    [key: string]: any;
  }
 ...
 */
export function setTextureFromArray(
  gl: WebGLRenderingContext,
  tex: WebGLTexture,
 ...
 */
export type ProgramCallback = (
  err?: string,
  result?: WebGLProgram | ProgramInfo
) => void;
/**
 ...
 * @memberOf module:twgl/programs
 */
export function createProgramInfoAsync(
  gl: WebGLRenderingContext,
  shaderSources: string[],
  opt_attribs?: ProgramOptions | string[] | ErrorCallback,
  opt_errorCallback?: ErrorCallback
 ...
 * @memberOf module:twgl/programs
 */
export function createUniformBlockSpecFromProgram(
  gl: WebGL2RenderingContext,
  program: WebGLProgram
): UniformBlockSpec;
/**
 ...
 * @memberOf module:twgl/programs
 */
export function createUniformBlockInfoFromProgram(
  gl: WebGL2RenderingContext,
  program: WebGLProgram,
  blockName: string
): UniformBlockInfo;
 ...
 * @memberOf module:twgl/programs
 */
export function setUniformsAndBindTextures(
  setters:
    | ProgramInfo
    | {
        [key: string]: (...params: any[]) => any;
 ...
 * @return {Object.<string, WebGLProgram>?} the created programInfos by name
 */
export function createProgramsAsync(
  gl: WebGLRenderingContext,
  programSpecs: {
    [key: string]: ProgramSpec;
  },
 ...
 */
export function createProgramInfosAsync(
  gl: WebGLRenderingContext,
  programSpecs: {
    [key: string]: ProgramSpec;
  },
 ...
 * @memberOf module:twgl/textures
 */
export function getBytesPerElementForInternalFormat(
  internalFormat: number,
  type: number
): number;
/**
 ...
 * @memberOf module:twgl/textures
 */
export function getFormatAndTypeForInternalFormat(
  internalFormat: number
): TextureFormatInfo;
/**
 ...
 * @memberOf module:twgl/textures
 */
export function canGenerateMipmap(
  gl: WebGLRenderingContext,
  width: number,
  height: number,
  internalFormat: number
 ...
 * @kind function
 */
export function setTextureFromElement(
  gl: WebGLRenderingContext,
  tex: WebGLTexture,
  element: HTMLElement,
  options?: TextureOptions
 ...
 * @memberOf module:twgl/textures
 */
export function setEmptyTexture(
  gl: WebGLRenderingContext,
  tex: WebGLTexture,
  options: TextureOptions
): void;
 ...
 * @memberOf module:twgl/typedArray
 */
export function getGLTypeForTypedArrayType(
  typedArrayType: ArrayBufferView
): number;
/**
 ...
 * @memberOf module:twgl/typedArray
 */
export function getTypedArrayTypeForGLType(
  type: number
): (...params: any[]) => any;
...
declare module primitives {
  ...
  export type AugmentedTypedArray<T extends TypedArray> = T &
    AugmentedTypedArrayHelper;
   ...
   */
  export function createAugmentedTypedArray<T extends TypedArrayConstructor>(
    numComponents: number,
    numElements: number,
    type: T
  ): AugmentedTypedArray<InstanceType<T>>;
  export function createAugmentedTypedArray<T extends Float32Array>(
    numComponents: number,
    numElements: number
  ): AugmentedTypedArray<Float32Array>;
   ...
   * @memberOf module:twgl/primitives
   */
  export function deindexVertices(vertices: { [key: string]: TypedArray }): {
   ...
   * @memberOf module:twgl/primitives
   */
  export function flattenNormals(vertices: { [key: string]: TypedArray }): {
    [key: string]: TypedArray;
  };
  /**
   ...
   * @memberOf module:twgl/primitives
   */
  export function reorientDirections(
   ...
   * @memberOf module:twgl/primitives
   */
  export function reorientNormals(
    array: number[] | TypedArray,
    matrix: m4.Mat4
  ): number[] | TypedArray;
  /**
   ...
   * @memberOf module:twgl/primitives
   */
  export function reorientPositions(
    array: number[] | TypedArray,
    matrix: m4.Mat4
  ): number[] | TypedArray;
  /**
   ...
   * @memberOf module:twgl/primitives
   */
  export function reorientVertices(
    arrays: {
   ...
   */
  export function createXYQuadBuffers(
    gl: WebGLRenderingContext,
    size?: number,
    xOffset?: number,
    yOffset?: number
   ...
   */
  export function createXYQuadBufferInfo(
    gl: WebGLRenderingContext,
    size?: number,
    xOffset?: number,
    yOffset?: number
   ...
   */
  export function createCubeBufferInfo(
    gl: WebGLRenderingContext,
    size?: number
  ): BufferInfo;
  /**
   ...
   */
  export function createCubeBuffers(
    gl: WebGLRenderingContext,
    size?: number
  ): {
    [key: string]: WebGLBuffer;
   ...
   */
  export function createCrescentBufferInfo(
    gl: WebGLRenderingContext,
    verticalRadius: number,
    outerRadius: number,
    innerRadius: number,
   ...
   */
  export function createCrescentBuffers(
    gl: WebGLRenderingContext,
    verticalRadius: number,
    outerRadius: number,
    innerRadius: number,
   ...
   * @memberOf module:twgl/primitives
   */
  export function makeRandomVertexColors(
    vertices: {
      [key: string]: ArrayBufferView;
    },
