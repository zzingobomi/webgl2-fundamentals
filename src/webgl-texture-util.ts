...
export var makeStripeTexture = function (gl, options) {
  options = options || {};
...
export var makeCheckerTexture = function (gl, options) {
  options = options || {};
  var width = options.width || 2;
  var height = options.height || 2;
  var color1 = options.color1 || "white";
...
export var makeCircleTexture = function (gl, options) {
  options = options || {};
...
export var makeRandomTexture = function (gl, options) {
  options = options || {};
